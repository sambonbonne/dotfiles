...
Echo "Change Gnome default settings"

SCREENSHOTS_DIRECTORY="${HOME}/media/images/screenshots"
mkdir -p "${SCREENSHOTS_DIRECTORY}"
gsettings set org.gnome.gnome-screenshot auto-save-directory "file://${SCREENSHOTS_DIRECTORY}"
gsettings set org.gnome.gnome-screenshot last-save-directory "file://${SCREENSHOTS_DIRECTORY}"
